...
            internal static partial int MilCompositionEngine_InitializePartitionManager(int nPriority);

            [LibraryImport(DllImport.MilCore)]
            internal static partial int MilCompositionEngine_DeinitializePartitionManager();

            [LibraryImport(DllImport.MilCore)]
            internal static partial long GetNextPerfElementId();
       }
    }
}
